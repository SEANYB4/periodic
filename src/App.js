    ...
    <div className="App">
      ...
      <div className='ptable'>
            ...
            <div className='col1'>
                  ...
                  <div className='element othernonmetals' onClick={handleClick}>H
                  <br></br>
                  <Link to="/H">Click</Link>
                  
                  </div>
                  <div className='element alkalimetals' onClick={handleClick}>Li
                  <br></br>
                  <Link to="/L">Click</Link></div>
